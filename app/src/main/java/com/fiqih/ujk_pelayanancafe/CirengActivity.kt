...
import kotlinx.android.synthetic.main.activity_cireng.*
import java.text.SimpleDateFormat
import java.util.*

class CirengActivity : AppCompatActivity() {
    val cal = Calendar.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cireng)
        ...
        et_tgl.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                ...
                DatePickerDialog(this@CirengActivity,
                    dateSetListener,
        ...
        et_jam.setOnClickListener(object: View.OnClickListener {
            override fun onClick(view: View) {
                ...
                TimePickerDialog( this@CirengActivity,
                    timeSetListener,
