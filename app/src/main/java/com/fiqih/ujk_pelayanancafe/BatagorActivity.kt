...
import kotlinx.android.synthetic.main.activity_batagor.*
...
import kotlinx.android.synthetic.main.activity_sparkling_tea.*
import kotlinx.android.synthetic.main.activity_sparkling_tea.btnhome3
import java.text.SimpleDateFormat
import java.util.*

class BatagorActivity : AppCompatActivity() {
    val cal = Calendar.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_batagor)
        ...
        et_tgl.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                ...
                DatePickerDialog(this@BatagorActivity,
                    dateSetListener,
        ...
        et_jam.setOnClickListener(object: View.OnClickListener {
            override fun onClick(view: View) {
                ...
                TimePickerDialog( this@BatagorActivity,
                    timeSetListener,
