...
class SparklingTeaActivity : AppCompatActivity() {
    val cal = Calendar.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sparkling_tea)
        ...
        et_tgl.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                ...
                DatePickerDialog(this@SparklingTeaActivity,
                    dateSetListener,
        ...
        et_jam.setOnClickListener(object: View.OnClickListener {
            override fun onClick(view: View) {
                ...
                TimePickerDialog( this@SparklingTeaActivity,
                    timeSetListener,
