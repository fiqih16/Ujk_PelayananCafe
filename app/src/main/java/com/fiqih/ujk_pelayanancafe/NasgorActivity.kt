...
import kotlinx.android.synthetic.main.activity_nasgor.*
import java.text.SimpleDateFormat
import java.util.*

class NasgorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        et_tgl.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                ...
                DatePickerDialog(this@NasgorActivity,
                    dateSetListener,
        ...
        et_jam.setOnClickListener(object: View.OnClickListener {
            override fun onClick(view: View) {
                ...
                TimePickerDialog( this@NasgorActivity,
                    timeSetListener,
