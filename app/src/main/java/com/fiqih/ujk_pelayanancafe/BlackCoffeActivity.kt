...
class BlackCoffeActivity : AppCompatActivity() {
    val cal = Calendar.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_black_coffe)
        ...
        et_tgl.setOnClickListener(object : View.OnClickListener {
            override fun onClick(view: View) {
                ...
                DatePickerDialog(this@BlackCoffeActivity,
                    dateSetListener,
        ...
        et_jam.setOnClickListener(object: View.OnClickListener {
            override fun onClick(view: View) {
                ...
                TimePickerDialog( this@BlackCoffeActivity,
                    timeSetListener,
